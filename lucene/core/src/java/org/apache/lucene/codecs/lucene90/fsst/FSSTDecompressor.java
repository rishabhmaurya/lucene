...
/**
 * Stateless FSST decompressor. For each byte: if not ESCAPE, copy the symbol bytes; otherwise copy
 * the next raw byte.
 */
public final class FSSTDecompressor {
  ...
  /** Decompresses compressed[off..off+len) into output. Returns decompressed length. */
